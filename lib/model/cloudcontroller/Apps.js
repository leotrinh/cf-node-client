...
class Apps extends CloudControllerBase {
    ...
    getApp(appGuid) {
        ...
        if (this.isUsingV3()) {
            return this._getAppV3(appGuid, token);
        } else {
            return this._getAppV2(appGuid, token);
        }
    }

    /**
     * Get app using v2 API
     * @private
     */
    _getAppV2(appGuid, token) {
    ...
    /**
     * Get app using v3 API
     * @private
     */
    _getAppV3(appGuid, token) {
