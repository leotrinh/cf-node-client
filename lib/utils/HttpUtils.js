...
class HttpUtils {
    ...
    */
     ...
     * @param {Object} data - Request body data (automatically JSON stringified)
     ...
     * @param {String} url - Request URL
     * @param {String} token - OAuth token
     * @param {Object} data - Request body data (automatically form stringified)
     * @param {Number} expectedStatus - Expected HTTP status code
     * @return {Promise} Resolves with response JSON
     */
    requestV2(method, url, token, data = null, expectedStatus = 200) {
        ...
        if (data && (method === "POST" || method === "PUT")) {
            options.form = data; // FIX: Send object directly, not stringified
        }
