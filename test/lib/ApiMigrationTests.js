...
describe('cf-node-client v1.0.1 - API v3 Migration', function () {
    this.timeout(5000);
    ...
    describe('Package Configuration', function () {
        ...
        it('should have version 1.0.1', function () {
            const pkg = require('../../package.json');
            expect(pkg.version).to.equal('1.0.1');
        });

        it('should have index.js export version 1.0.1', function () {
            const lib = require('../../index.js');
            expect(lib.version).to.equal('1.0.1');
        });
